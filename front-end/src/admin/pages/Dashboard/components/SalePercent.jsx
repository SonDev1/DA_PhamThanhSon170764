            ...
            extra={
                ...
                >
                    <Radio.Button value='all'>
                        {formatMessage({ id: 'app.dashboard.salePercent.all' })}
                    </Radio.Button>
                    <Radio.Button value='online'>
                        {formatMessage({ id: 'app.dashboard.salePercent.online' })}
                    </Radio.Button>
                    <Radio.Button value='offline'>
                        {formatMessage({ id: 'app.dashboard.salePercent.offline' })}
                    </Radio.Button>
                </Radio.Group>
            }
        >
