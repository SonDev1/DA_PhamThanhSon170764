...
export class ProductService {
  ...
  //   return `${product.description} ${product.dialSize} ${product.dialColor} ${product.movementType} ${product.strapMaterial} ${product.glassMaterial}`;
  // }
  ...
  //   let similarity = 0;
  //   tfidf1.listTerms(0).forEach(term1 => {
  //     const term1TFIDF = term1.tfidf;
  //     const term2 = tfidf2.listTerms(0).find(t => t.term === term1.term);
  //     if (term2) {
  //       similarity += term1TFIDF * term2.tfidf;
  //     }
  //   });
